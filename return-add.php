...
<head>
    ...
    <link href="assets/css/demo.css" rel="stylesheet" />
      ...
      $query = "SELECT bid, book_name FROM book ORDER BY book_name ASC";
      ...
      if(isset($_POST['submit'])){
          ...
          $time_return = mysqli_real_escape_string($conn,$_POST['']);
  
          $query_insert = "INSERT INTO book_return (studentname, bookname, time_return) VALUES($students, $books, NOW())";
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Return Books</h4>
                                </div>
                                <div class="card-body">
                                            ...
                                            <div class="col-md-6 pr-1">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="students">
                                                        ...
                                                        <?php foreach($students_ as $mystudents):?>
                                                            <option value="<?php echo $mystudents['student_name']?>" >
                                                                <?php echo $mystudents['student_name'];?>
                                                            </option>
                                                        <?php endforeach;?>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-md-6 pl-1">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="books">
                                                        <option>Select</option>
                                                        <?php foreach($books_ as $books):?>
                                                            <option value="<?php echo $books['book_name'] ?>">
