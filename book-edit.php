...
require "config/db.php";
            ...
            $query_Id = "SELECT * FROM book WHERE bid = $bid";

            $result_Id = mysqli_query($conn, $query_Id);

        if(count(array($result_Id))==1){
            $book = mysqli_fetch_array($result_Id);
...
//create insert query 
$update_query= "UPDATE book SET book_name = '$book_name', book_author = '$book_author', book_isbn ='$book_isbn', year_published = '$year_published', quantity = $quantity 
WHERE bid = $bid";
if(mysqli_query($conn, $update_query)){
    header("Location: http://localhost/elibrary/book.php");
}else{
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 pr-1">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="book_isbn"value="<?php echo $book_isbn; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 pr-1">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="year_published"value="<?php echo $year_published; ?>">
                                                </div>
                                            </div>
                                        </div>
